<!-- src/components/EditReviewModal.vue (修改版) -->
<template>
          ...
          <form @submit.prevent="submitEdit">
            ...
            <div class="rating-container">
              <h3 class="rating-section-title">
                <i class="bi bi-star-fill me-2"></i>評分
              </h3>
            ...
            <div class="content-container">
              <h3 class="content-section-title">
                <i class="bi bi-pencil-fill me-2"></i>評價內容
              </h3>
              
              <div class="form-group">
                <label for="reviewText">您的體驗描述</label>
                <textarea 
                  id="reviewText" 
              ...
              <div class="pros-cons-section">
                <div class="form-group">
                  <label for="pros">
                    <i class="bi bi-hand-thumbs-up-fill me-1"></i>優點
                  </label>
                  <textarea 
                    id="pros" 
                ...
                <div class="form-group">
                  <label for="cons">
                    <i class="bi bi-hand-thumbs-down-fill me-1"></i>缺點
                  </label>
                  <textarea 
                    id="cons" 
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span v-else>
                  <i class="bi bi-check2-circle me-1"></i>儲存修改
                </span>
              </button>
            </div>
          </form>
  ...
  /* 新增的評分區塊樣式 */
  .rating-container, .content-container {
  ...
  .rating-section-title, .content-section-title {
    color: #1E432E;
    font-size: 18px;
    margin-top: 0;
    margin-bottom: 20px;
